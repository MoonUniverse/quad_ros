...
xfce4-terminal  -T master -e "bash -iC 'echo start!; $SHELL'" \
        ...
        --tab   -T realsense_camera -e "bash -ic 'sleep 5; roslaunch realsense2_camera realsense_camera.launch; $SHELL'" \
        --tab   -T vins_fusion -e "bash -ic 'sleep 35; roslaunch vins vins_fusion.launch; $SHELL'" \
        --tab   -T vins_fusion -e "bash -ic 'sleep 15; roslaunch vins vins_rviz.launch; $SHELL'" \
