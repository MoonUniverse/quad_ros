...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber attitudeSub = nh.subscribe("dji_sdk/attitude", 1, &attitude_callback);
  ros::Subscriber gpsSub = nh.subscribe("dji_sdk/gps_position", 1, &gps_callback);
  ...
  ctrlPosYawPub = nh.advertise<sensor_msgs::Joy>("dji_sdk/flight_control_setpoint_ENUposition_yaw", 1);
