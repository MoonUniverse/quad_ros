...
xfce4-terminal  -T master -e "bash -iC 'echo start!; $SHELL'" \
        ...
        --tab   -T mavros_200hz -e "bash -ic 'sleep 15; rosrun mavros mavcmd long 511 105 5000 0 0 0 0 0; $SHELL'" \
        ...
        --tab   -T happymoon_quad_control -e "bash -ic 'sleep 45; roslaunch happymoon_quad_control happymoon_control.launch; $SHELL'" \
