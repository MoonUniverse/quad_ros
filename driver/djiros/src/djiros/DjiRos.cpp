...
DjiRos::DjiRos(ros::NodeHandle &nh, ros::NodeHandle &nh_private)
    : DJISDKNode(),
      ...
      ctrl_state(CtrlState_t::released), ctrl_cmd_wait_timeout_limit(0.0),
      ctrl_cmd_stream_timeout_limit(0.0), last_ctrl_stamp(ros::Time(0)),
      sdk_control_flag(false), m_verbose_output(false), m_hwsync_ack_count(0) {
